...
function Scene() {
    ...
    const [{ wobble, coat, color, ambient, env, }] = useSpring(
        {
          wobble: hovered ? 0.45 : 0.4,
          coat: !hovered ? 0.5 : 1,
          ambient: !hovered ? 1.5 : 1,
          env: !hovered ? 1.4 : 1,
          color: hovered ? '#FF90CC' : '#f0f0f0',
    ...
    return (
        <>
            <PerspectiveCamera makeDefault position={[0, 0, 4]} fov={75}>
                ...
                <aThree.pointLight ref={light} position-z={-15} intensity={env} color="#ff0000" />
            </PerspectiveCamera>
...
export default function Flower(){
    ...
    return(
        <a.main style={{ background: 'transparent', height: '100vh'}}>
